        ...
        <div className="w-full max-md space-y-6 mt-8 shrink-0">
            <div>
                ...
                <div className="flex gap-2">
                    <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="flex-1 bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-white transition-colors" />
